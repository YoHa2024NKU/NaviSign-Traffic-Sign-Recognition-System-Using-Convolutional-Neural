...
top.configure(background='#2C3E50')  # Dark blue background

# Heading
heading = Label(top, text="Traffic Sign Recognition", pady=20, font=('arial', 25, 'bold'))
heading.configure(background='#2C3E50', foreground='#E67E22')  # Orange heading
heading.pack()

# Image display frame with orange border
image_frame = Frame(top, bg='#2C3E50', highlightbackground='#E67E22', highlightthickness=2)
image_frame.pack(pady=20)
sign_image = Label(image_frame, bg='#2C3E50')
sign_image.pack()

# Prediction label
label = Label(top, text="No prediction yet", background='#2C3E50', foreground='#3498DB', font=('arial', 15, 'bold'))
label.pack()

# Confidence label
confidence_label = Label(top, text="0%", background='#2C3E50', foreground='#FFFFFF', font=('arial', 12, 'bold'))
confidence_label.pack(pady=5)

# Button frame
button_frame = Frame(top, bg='#2C3E50')
button_frame.pack(pady=20)

# Buttons with orange background
upload = Button(button_frame, text="Upload Image", command=lambda: upload_image(), padx=20, pady=10)
upload.configure(background='#E67E22', foreground='white', font=('arial', 12, 'bold'), borderwidth=0)
...
classify_b.configure(background='#E67E22', foreground='white', font=('arial', 12, 'bold'), borderwidth=0)
...
video_button.configure(background='#E67E22', foreground='white', font=('arial', 12, 'bold'), borderwidth=0)
video_button.pack(side=LEFT, padx=10)

reset_button = Button(button_frame, text="Reset", command=lambda: reset(), padx=20, pady=10)
reset_button.configure(background='#7F8C8D', foreground='white', font=('arial', 12, 'bold'), borderwidth=0)
reset_button.pack(side=LEFT, padx=10)

# Status label
status_label = Label(top, text="✔ Model loaded", background='#2C3E50', foreground='#2ECC71', font=('arial', 10))
